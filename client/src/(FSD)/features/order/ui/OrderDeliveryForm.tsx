                ...
                <AppInner>
                    ...
                    <div className={styles.form_body}>
                        <div className={styles.input_box}>
                            ...
                            <Input onClick={postcodeModalOnOpen} isReadOnly={true} isClearable={false} value={address ? address : (orderDeliveryInfo && orderDeliveryInfo.address) && orderDeliveryInfo.address.split(" / ")[0]} placeholder={"서울특별시 서대문구 노고산동 57-1"} />
                        </div>
                        <div className={styles.input_box}>
