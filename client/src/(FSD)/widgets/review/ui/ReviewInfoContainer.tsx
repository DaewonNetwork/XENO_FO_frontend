...
const ReviewInfoContainer = () => {
    ...
    const { data: productData, refetch } = useProductColorCardRead(reviewInfo?.productd);
        ...
        <>
            <div className={styles.order_product_info}>
                <div className={styles.info_image}>
                    <img className="" src={`data:image/jpeg;base64,${product.productImage}`} onClick={() => router.push(`/products/${product.productd}`)} />
                </div>
