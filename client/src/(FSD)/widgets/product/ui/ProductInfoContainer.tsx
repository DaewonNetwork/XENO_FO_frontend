...
const ProductInfoContainer = () => {
    ...
    const { data, isError, error, isPending, refetch } = useProductColorRead(+productd);
    ...
    return (
        <>
            ...
            <ProductDetailImage productd={productd} />
            <ReviewInfoList productd={productd} />
        </>
    );
};
